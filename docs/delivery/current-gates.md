...
| Gate 1 — Local scaffold approval             | Awaiting human approval | [Gate 1 evidence](./gate-1-evidence.md)                          | No external deployment         |
...
Passing automated checks does not approve a gate. A human must record the decision
explicitly.
